...
//@param long long int n - hatványkitevõ
...
bool bigint::operator<=(bigint other) {
	...
	// Ha mindegyik számjegy ugyanaz, akkor egyenlõek
	return true;
}
...
bigint& bigint::operator=(bigint& other) {
	if (this != &other) { // Önmagába másolás ellenõrzése
		this->num = other.num;
	}
	return *this;
}
...
bigint& bigint::operator-(long long int n) {
	...
	// Ha a második szám hosszabb, akkor felcseréli õket és elõjel problémákat kezeljük
	...
	// Eltávolítjuk a vezetõ nullákat, ha vannak
...
//Ugyanaz, mint long long int esetében, csak itt egy másik biginttel
//Figyelem! Csak átváltja a bigintet long long-ra. Elõfordulhat integer overflow.
//@param bigint num - osztás biginttel
bigint& bigint::operator/(bigint num) {
	std::string final = "0";			//Végleges eredmény
	std::string s = this->num;			//Elmentjük az eredeti számot rosszabb idõkre
